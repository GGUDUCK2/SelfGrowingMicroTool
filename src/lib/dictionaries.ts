  ...
  ko: {
    ...
    tools: {
      ...
      subnetScope: {
        ...
        type: "유형",
        public: "공인 IP (Public)",
        private: "사설 IP (Private)",
        loopback: "루프백 (Loopback)",
        multicast: "멀티캐스트",
        class: "클래스",
        version: "IP 버전",
        subnetting: "서브넷팅 (VLSM)",
        newMask: "새 마스크 / 크기",
        generate: "서브넷 생성",
        subnets: "서브넷 목록",
        range: "범위",
        ...
        faqTitle: "Subnet Scope FAQ",
        q1: "IPv6를 지원하나요?",
        a1: "네, Subnet Scope는 IPv6 주소 체계, 서브넷팅 및 시각화를 완벽하게 지원합니다.",
        q2: "CIDR이란 무엇인가요?",
        a2: "CIDR(Classless Inter-Domain Routing)은 IP 주소 할당 및 라우팅을 위한 방법입니다. 기존의 클래스 기반 네트워크 설계를 대체합니다.",
        q3: "이 도구는 오프라인인가요?",
        a3: "네, 모든 계산은 JavaScript를 사용하여 브라우저 내에서 이루어집니다. IP 데이터는 서버로 전송되지 않습니다.",
        guide: {
          title: "왜 Subnet Scope인가요?",
          intro: "Subnet Scope는 IP 주소 체계를 시각적으로 이해하고 계획해야 하는 네트워크 엔지니어와 학생을 위해 설계되었습니다. 이진수 수학의 복잡함을 제거합니다.",
          featuresTitle: "주요 기능",
          f1: "**듀얼 스택:** IPv4와 IPv6를 모두 매끄럽게 지원합니다.",
          f2: "**이진 시각화:** 넷마스크가 네트워크와 호스트 부분을 어떻게 나누는지 정확히 확인하세요.",
          f3: "**VLSM 계산기:** 효율적인 계획을 위해 네트워크를 더 작은 서브넷으로 쉽게 분할하세요.",
          tipsTitle: "프로 팁",
      ...
      chronoShift: {
        title: "Chrono Shift: 타임존 아키텍트",
        description: "글로벌 일정을 위한 완벽한 도구입니다. 시간대 중첩을 시각화하고, 회의를 계획하고, 전 세계 팀을 관리하세요.",
        home: "내 시간",
        addLocation: "장소 추가",
        ...
        downloaded: "다운로드됨!",
        goldenHour: "골든 아워 찾기",
        businessHours: "업무 시간 (9-5)",
        teams: {
            title: "팀 프리셋",
            save: "현재 팀 저장",
            namePlaceholder: "팀 이름 (예: 엔지니어링 팀)",
            saved: "팀 저장됨!"
        },
        guide: {
          title: "왜 Chrono Shift인가요?",
          intro: "Chrono Shift는 리모트 퍼스트 시대를 위해 설계되었습니다. 시간을 물리적 차원처럼 시각화하여 글로벌 팀을 위한 완벽한 시간을 직관적으로 찾을 수 있게 해줍니다.",
          featuresTitle: "주요 기능",
          f1: "**시각적 중첩:** 여러 대륙에 걸쳐 업무 시간이 어디서 겹치는지 즉시 확인하세요.",
          f2: "**스마트 스케줄링:** 슬라이더를 드래그하여 모든 사람의 시간을 동시에 조정하세요.",
          f3: "**팀 프리셋:** 자주 협업하는 팀원들을 그룹으로 저장하여 한 번의 클릭으로 불러오세요.",
          tipsTitle: "프로 팁",
          tip1: "**골든 아워** 버튼을 사용하여 모든 참가자에게 가장 좋은 시간으로 자동으로 이동하세요.",
          tip2: "**다운로드 .ics**를 클릭하여 아웃룩, 애플 캘린더, 구글 캘린더와 호환되는 일정 파일을 생성하세요.",
          tip3: "팀원들과 URL을 공유하세요 - 현재 상태가 링크에 인코딩되어 있습니다."
        },
        faqTitle: "Chrono Shift FAQ",
        q1: "'중첩 점수'는 어떻게 작동하나요?",
        a1: "참가자 중 정의된 업무 시간(기본 오전 9시 - 오후 5시) 내에 있는 사람의 비율을 계산합니다.",
        q2: "일광 절약 시간(DST)을 처리하나요?",
        a2: "네, Chrono Shift는 IANA 시간대 데이터베이스(date-fns-tz)를 사용하여 모든 위치의 DST 변경을 정확하게 처리합니다.",
        q3: "24시간 형식을 사용할 수 있나요?",
        a3: "현재 시각적 타임라인은 혼합 형식을 사용하지만, 추후 엄격한 24시간 토글 기능을 추가할 계획입니다."
      }
    },
    pwa: {
      title: "앱 설치하기",
