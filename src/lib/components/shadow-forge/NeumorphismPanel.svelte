...
<div class="space-y-6">
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-2 gap-2">
                ...
                <button class="py-2 px-3 text-sm font-medium rounded-lg border min-h-[44px] {$shadowStore.neumorphismConfig.shape === 'convex' ? 'bg-indigo-50 border-indigo-600 text-indigo-700 dark:bg-indigo-900/30 dark:border-indigo-500 dark:text-indigo-300' : 'border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'}" on:click={() => $shadowStore.neumorphismConfig.shape = 'convex'}>{dict.neumorphism.shapes.convex}</button>
                <button class="py-2 px-3 text-sm font-medium rounded-lg border min-h-[44px] {$shadowStore.neumorphismConfig.shape === 'pressed' ? 'bg-indigo-50 border-indigo-600 text-indigo-700 dark:bg-indigo-900/30 dark:border-indigo-500 dark:text-indigo-300' : 'border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'}" on:click={() => $shadowStore.neumorphismConfig.shape = 'pressed'}>{dict.neumorphism.shapes.pressed}</button>
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-2 gap-2">
            ...
            <button class="py-2 px-3 text-sm font-medium rounded-lg border min-h-[44px] {$shadowStore.neumorphismConfig.lightPosition === 'bottomLeft' ? 'bg-indigo-50 border-indigo-600 text-indigo-700 dark:bg-indigo-900/30 dark:border-indigo-500 dark:text-indigo-300' : 'border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'}" on:click={() => $shadowStore.neumorphismConfig.lightPosition = 'bottomLeft'}>{dict.neumorphism.directions.bottomLeft}</button>
            <button class="py-2 px-3 text-sm font-medium rounded-lg border min-h-[44px] {$shadowStore.neumorphismConfig.lightPosition === 'bottomRight' ? 'bg-indigo-50 border-indigo-600 text-indigo-700 dark:bg-indigo-900/30 dark:border-indigo-500 dark:text-indigo-300' : 'border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'}" on:click={() => $shadowStore.neumorphismConfig.lightPosition = 'bottomRight'}>{dict.neumorphism.directions.bottomRight}</button>
        </div>
    </div>
</div>
