...
Generated by Docker Forge (https://selfgrowingmicrotool.com/en/tools/docker-forge)
...
<div class="grid gap-8 relative lg:grid-cols-3 grid-cols-1">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-700/80 rounded-xl shadow-sm border border-blue-100 dark:border-slate-600 p-4">
      ...
      <div class="flex flex-wrap gap-2">
        {#each examples as example (example.name)}
          <button class="min-h-[44px] min-w-[44px] px-4 py-2 bg-white dark:bg-slate-800 hover:bg-blue-50 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium transition-colors shadow-sm flex items-center gap-2"
  ...
  <div class="space-y-6">
    ...
    <div class="bg-slate-900 rounded-xl shadow-lg overflow-hidden border border-slate-700">
      <div class="flex items-center justify-between px-4 py-2 border-b border-slate-800 bg-slate-950">
        ...
        <div class="flex space-x-2">
          <button
            class="text-slate-400 hover:text-white min-h-[44px] min-w-[44px] flex items-center justify-center p-2 transition-colors"
            on:click={() => copyToClipboard(compose)}
            title={d.copyToClipboard}
            aria-label={d.copyToClipboard}
          >
            <Copy size={16} />
    ...
    <div class="flex flex-col gap-2">
      <div class="grid gap-2 grid-cols-1 sm:grid-cols-2">
        <Button variant="primary" class="min-w-[44px] w-full min-h-[44px] flex items-center justify-center gap-2" aria-label={d.save} on:click={saveToHistory}>
          <Save size={18} /> {d.save}
        </Button>
        <Button variant="secondary" class="min-w-[44px] w-full min-h-[44px] flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white border-none" aria-label={d.downloadZip || 'Download ZIP'} on:click={downloadZip}>
