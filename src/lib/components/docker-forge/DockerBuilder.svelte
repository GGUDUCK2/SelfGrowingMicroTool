    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-700/80 rounded-xl shadow-sm border border-blue-100 dark:border-slate-600 p-4">
      ...
      <div class="flex flex-wrap gap-2">
        {#each examples as example (example.name)}
          <button class="min-h-[44px] min-w-[44px] px-4 py-2 bg-white dark:bg-slate-800 hover:bg-blue-50 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium transition-colors shadow-sm flex items-center gap-2 min-h-[44px] min-w-[44px]"
