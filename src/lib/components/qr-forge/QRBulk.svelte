...
<div class="space-y-4" role="region" aria-label="Bulk QR Generator">
    ...
    <button
        ...
        class="w-full flex items-center justify-center space-x-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-700 disabled:cursor-not-allowed text-white py-3 px-4 rounded-xl transition-all shadow-lg hover:shadow-indigo-500/20 min-h-[44px]"
    >
        {#if isGenerating}
