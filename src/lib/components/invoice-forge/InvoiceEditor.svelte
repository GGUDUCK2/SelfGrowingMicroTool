...
<div class="space-y-8 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 h-full overflow-y-auto">
  ...
  <!-- Meta -->
  <div class="grid gap-4 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
     <div class="space-y-1">
  ...
  <!-- Totals & Notes -->
  <div class="grid gap-6 pt-4 border-t border-gray-200 dark:border-gray-700 md:grid-cols-2 grid-cols-1">
     <div class="space-y-2">
