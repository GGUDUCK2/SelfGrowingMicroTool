...
<div class="space-y-4">
  <div class="flex flex-wrap gap-2 justify-between items-center mb-4">
    <div class="flex gap-2">
      <button
        class="flex items-center space-x-2 px-3 py-2 bg-indigo-50 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-colors"
        on:click={addRow}
      >
        <Plus size={16} />
    ...
    <div class="flex gap-2">
      <button
        class="flex items-center space-x-2 px-3 py-2 bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
