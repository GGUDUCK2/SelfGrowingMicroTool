...
<div class="flex items-center gap-2 p-2 bg-slate-100 dark:bg-slate-800 rounded-lg">
    <button
        class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-indigo-600 bg-white dark:bg-slate-700 dark:text-indigo-400 rounded-md shadow-sm hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors"
        on:click={autoFill}
    ...
    <button
        class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-600 bg-white dark:bg-slate-700 dark:text-slate-300 rounded-md shadow-sm hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
        on:click={clearAll}
    >
        <Trash2 size={16} />
        Clear
    ...
    <button
        class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-700 transition-colors"
