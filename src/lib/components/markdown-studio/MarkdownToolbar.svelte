...
<div class="flex flex-wrap items-center gap-1 p-2 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 rounded-t-lg">
  ...
  <div class="flex items-center gap-1 pr-2 border-r border-slate-300 dark:border-slate-600">
    <button
      class="p-1.5 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 rounded transition-colors"
  ...
  <div class="flex items-center gap-1 ml-auto">
    ...
    <button
      class="p-1.5 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 rounded transition-colors hidden sm:block"
