...
<div class="bg-white dark:bg-slate-800 rounded-xl border-l-4 shadow-sm overflow-hidden {isValid === true ? 'border-emerald-500' : isValid === false ? 'border-red-500' : 'border-blue-500'}">
  ...
  <div class="p-4 space-y-3">
    <div class="relative">
      <input
        type="text"
        class="w-full pl-10 pr-4 py-2 text-sm bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
