<script lang="ts">
  ...
  import { getHistory, toggleStar, deleteFromHistory, clearHistory, type XmlForgeHistoryItem } from '$lib/db/xml-forge';
  import { Star, Trash2, Clock, Code, FileJson } from '@lucide/svelte';

  export let dict: any;
  export let onSelect: (item: XmlForgeHistoryItem) => void;
