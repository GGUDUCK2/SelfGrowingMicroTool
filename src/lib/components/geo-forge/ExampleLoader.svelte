...
<div class="relative group z-10">
  ...
  <div class="absolute top-full left-0 mt-2 w-full max-w-xs bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-100 dark:border-slate-700 py-2 hidden group-hover:block">
