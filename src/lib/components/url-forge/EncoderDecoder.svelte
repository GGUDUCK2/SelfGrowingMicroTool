...
<div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
    ...
    <div class="flex gap-4">
        <button
            ...
            class="flex-1 px-4 py-3 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-800/50 text-indigo-700 dark:text-indigo-300 rounded-xl font-bold transition-colors flex items-center justify-center gap-2 touch-manipulation min-h-[44px]"
        >
        ...
        <button
            ...
            class="flex-1 px-4 py-3 bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-900/30 dark:hover:bg-emerald-800/50 text-emerald-700 dark:text-emerald-300 rounded-xl font-bold transition-colors flex items-center justify-center gap-2 touch-manipulation min-h-[44px]"
        >
