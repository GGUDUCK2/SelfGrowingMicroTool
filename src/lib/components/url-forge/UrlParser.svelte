...
<div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
    <div class="flex justify-between items-center mb-4">
        ...
        <button on:click={handleClear} class="text-sm text-slate-500 hover:text-red-500 transition-colors p-2" aria-label="Clear">
            {dict.clear}
        </button>
    </div>
        ...
        <div class="mt-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-xl border border-indigo-100 dark:border-indigo-800/50 group relative overflow-hidden">
                    ...
                    <button on:click={() => copyToClipboard(parsedUrl?.protocol || '')} class="absolute top-2 right-2 p-1 opacity-0 group-hover:opacity-100 text-indigo-500 hover:bg-indigo-200 dark:hover:bg-indigo-800 rounded transition-all" aria-label="Copy Protocol">
                ...
                <div class="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-xl border border-emerald-100 dark:border-emerald-800/50 col-span-2 group relative overflow-hidden">
                    ...
                    <button on:click={() => copyToClipboard(parsedUrl?.hostname || '')} class="absolute top-2 right-2 p-1 opacity-0 group-hover:opacity-100 text-emerald-500 hover:bg-emerald-200 dark:hover:bg-emerald-800 rounded transition-all" aria-label="Copy Host">
                         <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5v14l11-7z"/></svg>
                    </button>
                </div>
                ...
                <div class="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-xl border border-amber-100 dark:border-amber-800/50 group relative overflow-hidden">
                    ...
                    <button on:click={() => copyToClipboard(parsedUrl?.port || '')} class="absolute top-2 right-2 p-1 opacity-0 group-hover:opacity-100 text-amber-500 hover:bg-amber-200 dark:hover:bg-amber-800 rounded transition-all" aria-label="Copy Port">
                         <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5v14l11-7z"/></svg>
                    </button>
                </div>
                ...
                <div class="bg-sky-50 dark:bg-sky-900/20 p-4 rounded-xl border border-sky-100 dark:border-sky-800/50 col-span-2 md:col-span-3 group relative overflow-hidden">
                    ...
                    <span class="font-mono text-sm text-sky-900 dark:text-sky-200 truncate block">{parsedUrl.pathname}</span>
                     <button on:click={() => copyToClipboard(parsedUrl?.pathname || '')} class="absolute top-2 right-2 p-1 opacity-0 group-hover:opacity-100 text-sky-500 hover:bg-sky-200 dark:hover:bg-sky-800 rounded transition-all" aria-label="Copy Path">
                         <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5v14l11-7z"/></svg>
                    </button>
                </div>
                ...
                <div class="bg-rose-50 dark:bg-rose-900/20 p-4 rounded-xl border border-rose-100 dark:border-rose-800/50 group relative overflow-hidden">
                    ...
                    <button on:click={() => copyToClipboard(parsedUrl?.hash || '')} class="absolute top-2 right-2 p-1 opacity-0 group-hover:opacity-100 text-rose-500 hover:bg-rose-200 dark:hover:bg-rose-800 rounded transition-all" aria-label="Copy Hash">
                         <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5v14l11-7z"/></svg>
                    </button>
                </div>
            </div>
