...
<div class="flex items-center gap-2">
    <button
        ...
        class="flex items-center gap-2 px-3 py-1.5 min-h-[44px] min-w-[44px] bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-white transition-colors shadow-sm"
    >
