...
<div class="flex items-center gap-2">
    <button
        ...
        class="flex items-center gap-2 px-3 py-1.5 min-h-[44px] min-w-[44px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:bg-slate-800 hover:text-slate-900 dark:text-white transition-colors shadow-sm"
    >
