...
<div class="h-full w-full flex flex-col bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
  <div class="p-3 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between sticky top-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur z-10">
      ...
      <button class="text-indigo-600 dark:text-indigo-400 text-xs font-bold hover:underline">View All</button>
  </div>
              ...
              <div class="flex gap-3">
                  ...
                  <div class="flex-1 min-w-0">
                      ...
                      <div class="flex items-center gap-6 text-slate-400 text-xs font-medium">
                          <button class="flex items-center gap-1.5 hover:text-indigo-500 transition-colors group" aria-label="Comments">
                          ...
                          <button class="flex items-center gap-1.5 hover:text-red-500 transition-colors group" on:click={() => like(post.id)} aria-label="Like">
                          ...
                          <button class="flex items-center gap-1.5 hover:text-green-500 transition-colors group" aria-label="Share">
                          ...
                          <button class="ml-auto hover:text-slate-600 transition-colors" aria-label="Options">
