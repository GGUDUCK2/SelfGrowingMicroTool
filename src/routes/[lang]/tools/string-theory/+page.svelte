<script lang="ts">
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use String Theory",
    "description": "Step-by-step guide to using the String Theory tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
      ...
      <div class="flex justify-between items-center mb-2">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex gap-2">
                 <button on:click={copyText} class="text-slate-500 dark:text-slate-400 hover:text-indigo-600 transition-colors min-h-[44px] min-w-[44px]" aria-label="Copy" title="Copy">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3" />
                      </svg>
                 </button>
                  <button on:click={downloadText} class="text-slate-500 dark:text-slate-400 hover:text-indigo-600 transition-colors min-h-[44px] min-w-[44px]" aria-label="Download" title="Download">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                      </svg>
                 </button>
                 <button on:click={shareText} class="text-slate-500 dark:text-slate-400 hover:text-indigo-600 transition-colors min-h-[44px] min-w-[44px]" aria-label="Share" title="Share">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
