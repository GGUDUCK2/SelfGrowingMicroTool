...
<div class="space-y-8 relative">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <section class="lg:col-span-2 space-y-4" aria-label="Editor Workspace">
      <div class="flex justify-between items-center mb-2">
        <h2 class="text-xl font-bold text-slate-800 dark:text-white">{dictionary.input} / {dictionary.output}</h2>
  ...
  <section class="mt-20 prose dark:prose-invert max-w-4xl mx-auto">
    <h2 class="text-3xl font-bold text-slate-900 dark:text-white">{dictionary.guide.title}</h2>
    <p class="text-lg text-slate-600 dark:text-slate-400">{dictionary.guide.intro}</p>
    ...
    <div class="grid md:grid-cols-3 gap-8 my-12">
      <div class="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900/50">
        <h3 class="text-indigo-900 dark:text-indigo-300 font-bold mb-3">{dictionary.guide.featuresTitle}</h3>
      ...
      <div class="bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-900/50">
        <h3 class="text-emerald-900 dark:text-emerald-300 font-bold mb-3">{dictionary.guide.tipsTitle}</h3>
