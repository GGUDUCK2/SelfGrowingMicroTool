<script lang="ts">
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Icon Forge",
    "description": "Step-by-step guide to using the Icon Forge tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
...
<svelte:head>
  ...
  <link rel="canonical" href={$page.url.origin + "/" + lang + "/tools/icon-forge"} />
  <link rel="alternate" hreflang="en" href={$page.url.origin + "/en/tools/icon-forge"} />
  <link rel="alternate" hreflang="ko" href={$page.url.origin + "/ko/tools/icon-forge"} />
  <link rel="alternate" hreflang="x-default" href={$page.url.origin + "/en/tools/icon-forge"} />
  <!-- Twitter -->
  ...
  {@html `<script type="application/ld+json">
    {
      ...
      "@type": "SoftwareApplication",
        "@id": $page.url.origin + "/" + lang + "/tools/icon-forge",
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12" in:fade={{ duration: 300 }}>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
    <RelatedTools lang={lang as 'en' | 'ko'} currentSlug="icon-forge" currentCategory="design" />
  </div>
</div>
