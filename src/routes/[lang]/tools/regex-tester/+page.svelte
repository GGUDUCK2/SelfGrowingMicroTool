<script lang="ts">
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Regex Tester",
    "description": "Step-by-step guide to using the Regex Tester tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
  ...
  <div class="grid lg:grid-cols-12 gap-6 mb-16">
    ...
    <div class="lg:col-span-8 space-y-6">
      ...
      <div class="flex flex-wrap gap-4">
        <button class="flex-1 py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium shadow-lg shadow-indigo-200 dark:shadow-none transition-all flex items-center justify-center gap-2 min-h-[44px] min-w-[44px]"
        ...
        <button class="flex-1 py-2 px-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-750 rounded-lg font-medium transition-all flex items-center justify-center gap-2 min-h-[44px] min-w-[44px]"
          on:click={copyLink}
        >
          ...
          <div class="space-y-2">
            {#each $history as item}
              <div class="flex items-center justify-between p-3 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 group">
                <button class="flex-grow min-w-0 mr-3 text-left focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded p-1 min-h-[44px] min-w-[44px]" on:click={() => loadHistory(item)}>
