<script lang="ts">
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Invoice Forge",
    "description": "Step-by-step guide to using the Invoice Forge tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
  ...
  <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30 print:hidden">
    <div class="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <div class="flex items-center gap-4">
            <a href="/{lang}" aria-label="Go Home" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full text-gray-500 min-h-[44px] min-w-[44px] flex items-center justify-center">
                <ArrowLeft size={20} />
            </a>
