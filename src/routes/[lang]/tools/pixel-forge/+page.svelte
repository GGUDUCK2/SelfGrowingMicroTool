<script lang="ts">
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Pixel Forge",
    "description": "Step-by-step guide to using the Pixel Forge tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
  ...
  <!-- Features Grid -->
  <section class="grid sm:grid-cols-2 md:grid-cols-3 gap-8 pt-12 border-t border-slate-800">
     <div class="space-y-3">
