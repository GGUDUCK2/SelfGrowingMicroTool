<script lang="ts">
  ...
  $: t = (dict as any)?.tools?.subnetScope || {};
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Subnet Scope",
    "description": "Step-by-step guide to using the Subnet Scope tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
        ...
        {#if result.valid}
                ...
                <div class="space-y-8" in:fade>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white">{t.binary}</h3>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="card group">
                            <div class="flex justify-between items-start">
                                <span class="label">{t.broadcast}</span>
                        ...
                        <div class="card group">
                            <div class="flex justify-between items-start">
                                <span class="label">{t.netmask}</span>
                        ...
                        <div class="card group">
                            <div class="flex justify-between items-start">
                                <span class="label">{t.firstHost}</span>
                        ...
                        <div class="card group">
                            <div class="flex justify-between items-start">
                                <span class="label">{t.lastHost}</span>
            ...
            {:else if activeTab === 'subnetting'}
                <div class="space-y-8" in:fade>
                        ...
                        <div class="flex flex-wrap items-end gap-6">
                            ...
                            <div class="flex-1 min-w-[200px]">
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                                    {t.newMask} (/{result.subnetMaskLength ? result.subnetMaskLength + 1 : 0} - /{result.version === 4 ? 32 : 128})
                                    <input
                                        type="number"
                                        bind:value={newMask}
                    ...
                    <SubnetTable {subnets} dict={t} commonDict={commonDict} />
                </div>
            {/if}
        {:else}
                        ...
                        <div class="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 flex justify-between items-center hover:shadow-md transition-shadow">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button on:click={() => restore(item)}
                                    class="px-3 py-1.5 min-h-[44px] text-sm bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-300 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/50 min-w-[44px]"
                                >
                                    {t.restore}
                                </button>
