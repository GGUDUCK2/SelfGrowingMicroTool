<script lang="ts">
  ...
  $: jsonLd = {
      ...
      "@type": "SoftwareApplication",
        "@id": $page.url.origin + "/" + lang + "/tools/prompt-forge",
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Prompt Forge",
    "description": "Step-by-step guide to using the Prompt Forge tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
...
<svelte:head>
  ...
  <link rel="canonical" href={$page.url.origin + "/" + lang + "/tools/prompt-forge"} />
  <link rel="alternate" hreflang="en" href={$page.url.origin + "/en/tools/prompt-forge"} />
  <link rel="alternate" hreflang="ko" href={$page.url.origin + "/ko/tools/prompt-forge"} />
  <link rel="alternate" hreflang="x-default" href={$page.url.origin + "/en/tools/prompt-forge"} />
  <!-- Twitter -->
...
<div class="flex h-[100dvh] overflow-hidden bg-slate-50 dark:bg-slate-900">
  ...
  <!-- Sidebar -->
  <div class="fixed inset-y-0 left-0 z-50 w-full max-w-sm bg-white dark:bg-slate-800 shadow-xl transform transition-transform duration-300 md:relative md:translate-x-0 md:shadow-none border-r border-slate-200 dark:border-slate-700 {showSidebar ? 'translate-x-0' : '-translate-x-full'}">
  ...
  <!-- Backdrop -->
  {#if showSidebar}
    <button class="fixed inset-0 bg-black/50 z-40 md:hidden cursor-default w-full h-full border-none min-h-[44px] min-w-[44px]"
