<script lang="ts">
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Csp Forge",
    "description": "Step-by-step guide to using the Csp Forge tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
      ...
      <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
         <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div class="flex flex-wrap gap-2">
               <span class="text-sm text-slate-500 dark:text-slate-400 self-center mr-2">{(dict as any)?.presets}:</span>
