<script lang="ts">
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Jwt Forge",
    "description": "Step-by-step guide to using the Jwt Forge tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
  ...
  <div class="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="space-y-6">
      <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
        ...
        />
        {#if error}
            <div class="mt-2 text-red-500 dark:text-red-400 text-sm font-medium flex items-center gap-2">
