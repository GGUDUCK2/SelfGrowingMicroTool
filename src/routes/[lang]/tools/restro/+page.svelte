<script lang="ts">
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Restro",
    "description": "Step-by-step guide to using the Restro tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
    ...
    <div class="flex-1 flex flex-col md:flex-row overflow-visible md:overflow-hidden">
      ...
      <div class="flex-none md:flex-1 flex flex-col p-4 overflow-visible md:overflow-hidden min-w-[300px] min-h-[600px] md:min-h-0 border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-700">
         ...
         <div class="flex-1 overflow-hidden mt-2">
            <RequestTabs bind:params bind:headers bodyType={bodyType as any} on:change={(e) => bodyType = e.detail} bind:bodyContent {dict} />
         </div>
      </div>
...
{/if}
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
    <RelatedTools lang={lang as 'en' | 'ko'} currentSlug="restro" currentCategory="dev" />
  </div>
