    ...
    <header class="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
             <div class="flex items-center gap-2">
                 <a href="/{lang}" aria-label="Back to home" class="text-slate-500 hover:text-slate-900 dark:text-slate-50 dark:hover:text-white min-h-[44px] min-w-[44px] flex items-center justify-center p-2 -ml-2 rounded-lg">
