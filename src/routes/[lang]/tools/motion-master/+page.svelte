<script lang="ts">
  ...
  $: jsonLd = {
    ...
    "@type": "SoftwareApplication",
        "@id": $page.url.origin + "/" + lang + "/tools/motion-master",
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Motion Master",
    "description": "Step-by-step guide to using the Motion Master tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
...
<svelte:head>
  <link rel="canonical" href={$page.url.origin + "/" + lang + "/tools/motion-master"} />
