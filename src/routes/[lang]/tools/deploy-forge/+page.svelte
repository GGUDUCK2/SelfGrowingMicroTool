<script lang="ts">
  ...
  $: faqItems = [
    { q: ((dict as any)?.tools?.deployForge || {}).q1, a: ((dict as any)?.tools?.deployForge || {}).a1 },
    { q: ((dict as any)?.tools?.deployForge || {}).q2, a: ((dict as any)?.tools?.deployForge || {}).a2 },
    { q: ((dict as any)?.tools?.deployForge || {}).q3, a: ((dict as any)?.tools?.deployForge || {}).a3 }
  ];
  ...
  $: howToSchema = {
    ...
    "@type": "HowTo",
    "name": "How to use Deploy Forge",
    "description": "Step-by-step guide to using the Deploy Forge tool.",
    "step": [
        {
            "@type": "HowToStep",
            "name": "Configure Tool",
...
<div class="min-h-screen bg-slate-900 text-slate-100 pb-20">
  ...
  <AdPlaceholder />
  <FAQSection
                    title={((dict as any)?.tools?.deployForge || {}).faqTitle}
                    items={faqItems}
                />
            </div>
        </div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
    <RelatedTools lang={lang as 'en' | 'ko'} currentSlug="deploy-forge" currentCategory="dev" />
  </div>
</main>
</div>
