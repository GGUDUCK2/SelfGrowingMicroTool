...
<div class="max-w-2xl mx-auto py-12 space-y-12">
    ...
    <section class="text-center space-y-4" in:fly={{ y: 20, duration: 600 }}>
        ...
        <h1 class="text-4xl font-bold text-gray-900 dark:text-slate-100">{dict.pwa.title}</h1>
    ...
    <!-- Install Section -->
    <section
        class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-100 dark:border-slate-700 p-8 space-y-6"
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3">
                    ...
                    >
                        ...
                        <p class="text-gray-700 dark:text-slate-300">{dict.pwa.iosStep1}</p>
                    </div>
                    <div
                        class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl"
                    >
                        ...
                        <p class="text-gray-700 dark:text-slate-300">{dict.pwa.iosStep2}</p>
                    </div>
                </div>
            </div>
        {:else}
    ...
    <section class="space-y-6" in:fly={{ y: 20, duration: 600, delay: 400 }}>
        <h2 class="text-2xl font-bold text-gray-900 dark:text-slate-100 text-center">
            {dict.pwa.benefits}
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
                class="flex items-center gap-4 p-5 bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm"
            >
                ...
                <p class="text-gray-700 dark:text-slate-300 font-medium">{dict.pwa.benefit1}</p>
            </div>
            <div
                class="flex items-center gap-4 p-5 bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm"
            >
                ...
                <p class="text-gray-700 dark:text-slate-300 font-medium">{dict.pwa.benefit2}</p>
            </div>
            <div
                class="flex items-center gap-4 p-5 bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm"
            >
                ...
                <p class="text-gray-700 dark:text-slate-300 font-medium">{dict.pwa.benefit3}</p>
            </div>
            <div
                class="flex items-center gap-4 p-5 bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm"
            >
                ...
                <p class="text-gray-700 dark:text-slate-300 font-medium">{dict.pwa.benefit4}</p>
            </div>
        </div>
    </section>
</div>
