...
<div class="space-y-12">
  <section class="text-center py-20 space-y-6">
    <h1 in:fly={{ y: 20, duration: 800 }} class="text-5xl md:text-7xl font-extrabold tracking-tight text-gray-900">
      <span class="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">
        {dict.home.title}
      </span>
    </h1>
    <p in:fly={{ y: 20, duration: 800, delay: 200 }} class="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
    ...
    {#each tools as tool, i}
      ...
      >
        ...
        <div class="relative z-10">
          <div class="mb-6 inline-flex p-3 rounded-xl bg-indigo-50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-colors duration-300">
             ...
             {:else if tool.slug === 'compound-interest-calculator'}
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-up"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>
             {:else}
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wrench"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>
             {/if}
          </div>
          
          <h2 class="text-2xl font-bold text-gray-900 mb-3 ml-1 group-hover:text-indigo-600 transition-colors">
            {tool.title[lang]}
          </h2>
